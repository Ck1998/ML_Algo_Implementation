DATASET_MAPPINGS = {
    1: {
        "name": "Malware",
        "location": "datasets/big_malware/data.csv",
        "features": [
            "asm_commands_add",
            "asm_commands_call",
            "asm_commands_cdq",
    ...
    2: {
        "name": "Fake_News",
        "location": "datasets/fake_news/fake_news_dataset.csv",
        "features": [
            "domain_rank",
            "spam_score",
            "participants_count",
    ...
    3: {
        "name": "IOT",
        "location": "datasets/iot_detect/iot_device.csv",
        "features": [
            "ack",
            "ack_A",
            "ack_B",
    ...
    4: {
        ...
        "location": "datasets/file_pe/file_pe.csv",
        "features": [
            "e_magic",
            "e_cblp",
            "e_cp",
